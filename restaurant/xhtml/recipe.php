...
<div id="container">
        <div id="body">
                ...
                <div style="text-align:center;font-size:xx-small">
                        ...
                        <a href="">ﾒｲﾝ肉</a>/<a href="">ﾋﾟｻﾞ</a>/<a href="">ﾘｿﾞｯﾄ</a>/<a href="">ﾊﾟｽﾀ</a>/<a href="covering.php">まかない料理</a>
                </div>
                <table><tr><td></td></tr></table>
                <div id="menu_list">
                        ...
                        <div class="cook_sum" style="width:240;margin:auto;text-align:center;background:#">
                                ...
                                ?>
                                        <a href="recipe_detail.php?food_num=<?= $i ?>"><img src="img/food/a<?= $ii; ?>.gif" width="70" style="border:1px;border-color:#CCC;border-style:solid;margin:1px;margin-bottom:5px" /></a>
                                <?
                                                if($i == 3){
