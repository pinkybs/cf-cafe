        ...
        <div id="body">
                <div id="menu_list">
                        ...
                        <div style="text-align:center;">
                                <img src="img/food/a01.gif" />
                        </div>
                        <table><tr><td></td></tr></table>
                        <div style="text-align:left;font-size:xx-small">
                                <img src="img/0_6_sum.gif" style="float:left;margin-right:5px" align="left" />
                                フォアグラと焼き加減が絶妙！！
                        </div>
                        <div style="text-align:left;font-size:xx-small">
                                お腹が膨れました。<br />
                        ...
                        <div style="text-align:left;font-size:xx-small">
                                <span style="color:#F00">【ﾚｼﾋﾟ習得!】</span><br />
                                『タルタルステーキ』を習得しました!
                                <a href="get_recipe.php">早速作ってみる</a>
                        </div>
